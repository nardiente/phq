  ...
  <div className="flex flex-col gap-[15px] items-start relative">
   <div className="relative w-full h-[17px] bg-transparent">
    <p className="text-[15px] leading-[18px] tracking-[0.005em] text-slate-600">
     <span className="text-slate-600 text-[15px] tracking-[0.005em] font-medium">Borderless</span>
    </p>
   </div>
   <div
    className="rounded-xl border border-gray-200 flex flex-col gap-0 items-start relative w-[475px] bg-white"
   >
    <div
     className="flex flex-col gap-0 justify-center items-start self-stretch relative w-full h-[50px]"
    >
     <div
      className="px-5 py-[15px] flex gap-5 items-center self-stretch relative w-full"
     >
      <svg
       width="16"
       height="16"
      ...
      <div className="flex gap-3 items-center flex-1 relative w-full">
       <p className="text-base leading-6 tracking-[0.005em] text-[#110733]">
        <span className="text-[#110733] text-base tracking-[0.005em] font-bold">
         Accordion Item
        </span>
       </p>
      </div>
    ...
    <div
     className="pl-14 pr-5 pt-0 pb-[15px] flex flex-col gap-2.5 items-start self-stretch relative w-full"
    >
    ...
    <div
     className="flex flex-col gap-0 justify-center items-start self-stretch relative w-full h-[39px]"
    >
     ...
     >
      ...
      <div className="flex gap-3 items-center flex-1 relative w-full">
       <p className="text-base leading-6 tracking-[0.005em] text-[#44009a]">
        <span className="text-[#44009a] text-base tracking-[0.005em] font-bold">
...
export default AccordionBorderless;