  ...
  if (preview) {
    return (
      <div className="absolute inset-0">
        {settings.launcherPosition === 'right' ? (
          <div className="absolute top-1/2 right-0 -translate-y-1/2">
            <div
              className="flex items-center gap-2 px-4 py-2.5 shadow-lg relative"
              style={{
            ...
            >
              <NotificationBadge
                ...
                className="transform rotate-180 !-top-2 !-left-2 !-right-auto"
              />
              {settings.icon === 'Bell' ? (
                <Bell className="w-4 h-4 text-white transform rotate-180" />
              ) : (
                <Megaphone className="w-4 h-4 text-white transform rotate-180" />
              )}
