                ...
                {selectedTemplate === 'Admin edited my Idea' ? (
                  ...
                  <div>
                    ...
                    <div className="border-t pt-3">
                      ...
                      {(email?.ideas?.idea_created_on_behalf ||
                        email?.ideas?.idea_was_approved) && (
                        <div className="mb-4">
                          <h4 className="text-[15px] font-medium text-gray-900 mb-2">
                            New Ideas
                          </h4>
                      ...
                      {email?.comments?.comment_on_idea && (
                        <div className="mb-4">
                          <h4 className="text-[15px] font-medium text-gray-900 mb-2">
                            New Comments
                          </h4>
                          <div className="text-[14px] text-gray-700 pl-2">
                            ...
                            <p className="text-[13px]">
                              • New comment on "Mobile app improvements"
                            </p>
                          </div>
                        </div>
                      )}

                      {email?.ideas?.new_vote_on_idea && (
                        <div className="mb-4">
                          <h4 className="text-[15px] font-medium text-gray-900 mb-2">
                            New Feedback
                          </h4>
                          <div className="text-[14px] text-gray-700 pl-2">
                            ...
                            <p className="text-[13px]">
                              • Feedback on new feature release
                            </p>
                          </div>
                        </div>
                      )}
