...
export default function DashboardPage() {
  ...
  const recentIdeas = [
    ...
    { title: '[Example Idea] Pabbly Connect Integration', votes: 0, date: '9 Oct' },
    { title: '[Read Me] Change your Topics', votes: 0, date: '9 Oct' },
    { title: '[Example Idea] Custom Domains', votes: 0, date: '9 Oct' },
    { title: '[Read Me] We\'ve created a few example ideas for you', votes: 1, date: '9 Oct' }
  ];
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-gray-900">Total Active Ideas</h2>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Recent Ideas</h2>
