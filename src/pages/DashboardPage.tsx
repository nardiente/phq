import { LineChart, RefreshCw, ArrowUp, ArrowDown, Calendar } from 'lucide-react';
...
export default function DashboardPage() {
    ...
    return users.filter((user) => {
      ...
      return Object.keys(segment.filters).every((attribute) => {
        ...
        switch (filter.operator) {
          ...
          case 'contains':
            return String(value).toLowerCase().includes(String(filter.filterValue).toLowerCase());
          case 'starts with':
            return String(value).toLowerCase().startsWith(String(filter.filterValue).toLowerCase());
          case 'ends with':
            return String(value).toLowerCase().endsWith(String(filter.filterValue).toLowerCase());
  ...
  const stats = [
    ...
    { label: 'Customer Lifetime Value (CLTV)', value: '$500', change: '3%', trend: 'up' },
  ...
  // Sort ideas by votes
  const mostVotedIdeas = [...ideas].sort((a, b) => (b.votes || 0) - (a.votes || 0)).slice(0, 3);
  ...
  return (
    <div className="flex-1 px-8 py-6" style={{ opacity: 0.5 }}>
      ...
      <h2 className="text-lg font-semibold text-gray-900 mt-8 mb-4">User Segmentation</h2>
        ...
        {stats.map((stat, index) => (
          ...
          >
            ...
            <div className="flex items-center">
              ...
              <div className={`ml-2 text-sm ${stat.trend === 'up' ? 'text-green-500' : 'text-red-500'}`}>
                {stat.change}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Most Upvotes</div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Most Comments</div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Ideas Shipped</div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Oldest Ideas</div>
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">What's New</h2>
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Most Viewed</div>
          {mostVotedIdeas.map((idea) => (
            <div key={idea.id} className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-500">{idea.title}</div>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Most Clicks</div>
          {sortedIdeas.map((idea) => (
            <div key={idea.id} className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-500">{idea.title}</div>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Most Reactions</div>
          {filteredIdeas.map((idea) => (
            <div key={idea.id} className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-500">{idea.title}</div>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Most Shared</div>
          {filteredCommentedIdeas.map((idea) => (
            <div key={idea.id} className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-500">{idea.title}</div>
            </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Most Ideas</div>
          {filteredIdeas.map((idea) => (
            <div key={idea.id} className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-500">{idea.title}</div>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-base font-medium text-gray-700 mb-1">Team Member Activity</div>
          {filteredCommentedIdeas.map((idea) => (
            <div key={idea.id} className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-500">{idea.title}</div>
            </div>
