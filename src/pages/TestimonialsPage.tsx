...
export default function TestimonialsPage({ hideGoZenBranding }: TestimonialsPageProps) {
  useEffect(() => {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="text-center" style={{ width: 'calc(75% + 40px)', height: 'calc(75% + 70px)' }}>
        ...
        <div className="bg-white rounded-xl border border-gray-300 shadow-lg space-x-2 px-4 py-2 absolute bottom-5 right-5 inline-flex items-center justify-center cursor-pointer">
          {!hideGoZenBranding && (
            <>
              ...
              <p className="text-base font-semibold tracking-wide">Powered by GoZen Testimonials</p>
            </>
          )}
        </div>
      </div>
