...
export const FAVICON_PLACEHOLDER =
  'https://s3.us-east-1.amazonaws.com/uat-app.productfeedback.co/static/icons/favicon.ico';
export const FAVICON_EMPTY_PLACEHOLDER = 'data:image/png;base64,iVBORw0KGgo=';
